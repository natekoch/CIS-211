...
def decode(word: int) -> Instruction:
    ...
    return Instruction(OpCode(instr_field.extract_signed(word)), CondFlag(cond_field.extract_signed(word)), reg_target_field.extract_signed(word), 
    reg_src1_field.extract_signed(word), reg_src2_field.extract_signed(word), 
