...
class Test_Non_Overlapping(unittest.TestCase):

    def test_non_overlapping1(self):
        bitfield0_3 = BitField(0,3)
        bitfield4_6 = BitField(4,6)
        bitfield7_10 = BitField(7,10)
        
        field_bits = 0b10000000000
        
        inserted4_6 = bitfield4_6.insert(0b1111, field_bits) #has binary number over the bounds of the bitfield
        extracted4_6 = bitfield4_6.extract(0b111)
        self.assertEqual(inserted4_6, 0b10001110000)

    def test_non_overlapping2(self):
        bitfield0_4 = BitField(0,4)
        bitfield5_7 = BitField(5,7)
        bitfield8_11 = BitField(8,11)
        
        field_bits = 0b101010101010
        
        inserted8_11 = bitfield8_11.insert(0b111111, field_bits) #has binary number over the bounds of the bitfield
        extracted8_11 = bitfield8_11.extract(0b1111)
        self.assertEqual(inserted8_11, 0b111110101010)
